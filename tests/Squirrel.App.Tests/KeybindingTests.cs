...
public class KeybindingTests
{
    ...
    public void Physical_binding_wins_over_logical_on_the_same_keystroke()
    {
        ...
        {
            new Squirrel.App.Input.KeyBinding(KeyScope.Editor, GestureParser.Parse("Ctrl+A"), "logical"),
            new Squirrel.App.Input.KeyBinding(KeyScope.Editor, GestureParser.Parse("Ctrl+PhysBracketRight"), "physical"),
        });
